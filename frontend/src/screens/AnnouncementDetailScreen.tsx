...
import { View, Text, TouchableOpacity, ScrollView, StatusBar, Dimensions, Image, useWindowDimensions } from 'react-native';
                 ...
                 <View className="mb-6 gap-3">
                    {item.lokasi && (
                      <View className="flex-row items-center bg-slate-50 p-3 rounded-2xl border border-slate-100">
                         ...
                         <View>
                            <Text className="text-slate-400 text-[10px] font-bold uppercase">Lokasi</Text>
                            <Text className="text-slate-700 font-bold text-sm">{item.lokasi}</Text>
                         </View>
                      </View>
                    )}
                    {item.jam && (
                      <View className="flex-row items-center bg-slate-50 p-3 rounded-2xl border border-slate-100">
                         ...
                         <View>
                            <Text className="text-slate-400 text-[10px] font-bold uppercase">Waktu</Text>
                            <Text className="text-slate-700 font-bold text-sm">{item.jam}</Text>
                         </View>
                      </View>
                    )}
                 </View>
